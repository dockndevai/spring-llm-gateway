...
public final class LlmAttributes {
	...
	public static final String LLM_REQUEST_ATTR = "io.github.llmgw.gateway.request";

	/** The authenticated {@link io.github.llmgw.gateway.auth.LlmPrincipal}. */
	public static final String LLM_PRINCIPAL_ATTR = "io.github.llmgw.gateway.principal";

	/** The {@link io.github.llmgw.gateway.usage.TokenUsage} scraped from the upstream response. */
	public static final String LLM_USAGE_ATTR = "io.github.llmgw.gateway.usage";
	 ...
	 */
	public static final String LLM_USAGE_CALLBACKS_ATTR = "io.github.llmgw.gateway.usageCallbacks";

	/**
	 * The request path as it arrived, captured before the circuit breaker rewrites the request
	 * URI to the fallback path.
	 */
	public static final String LLM_ORIGINAL_PATH_ATTR = "io.github.llmgw.gateway.originalPath";

	/** Set when the model in the body was rewritten (fallback to a smaller model). */
	public static final String LLM_ROUTED_MODEL_ATTR = "io.github.llmgw.gateway.routedModel";
