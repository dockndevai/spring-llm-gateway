 ...
 * {@link io.github.llmgw.gateway.filter.LlmBodyGlobalFilter} (or, when a route selects on the
 * model, by {@link io.github.llmgw.gateway.predicate.LlmModelRoutePredicateFactory}).
 *
